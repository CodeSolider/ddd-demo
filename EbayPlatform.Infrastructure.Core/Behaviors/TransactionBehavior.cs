...
namespace EbayPlatform.Infrastructure.Core.Behaviors
{
    ...
    public class TransactionBehavior<TDbContext, TRequest, TResponse> :
        IPipelineBehavior<TRequest, TResponse> where TDbContext : EFContext
    {
        private readonly ILogger _logger;
        private readonly TDbContext _dbContext;
        private readonly ICapPublisher _capPublisher;
        public TransactionBehavior(TDbContext dbContext, ICapPublisher capPublisher, ILogger logger)
        {
